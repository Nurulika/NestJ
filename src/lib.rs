...
#[derive(Debug)]
pub struct NestJSModuleProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NestJSModuleProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NestJSModule processing");
    
    let mut processor = NestJSModuleProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NestJSModuleProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NestJSModuleProcessor::new(false);
